...
- [ ] 9.4 `/opsx:verify` this change against artifacts; then feature branch `feat/llm-wiki-kurs`, commit, PR with scope description. **(Awaiting user go-ahead — commit/PR are outward-facing actions.)**
