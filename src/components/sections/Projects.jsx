    ...
    >
      ...
      <div className="relative overflow-hidden rounded-lg mb-6 bg-dark-600 h-48">
        ...
        {(project.githubUrl || project.liveUrl) && (
          <div className="absolute inset-0 z-20 bg-dark-900/0 group-hover:bg-dark-900/90 transition-all duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100">
