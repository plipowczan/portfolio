...
| Nowa rola zawodowa | Kluczowe kompetencje                     | Zastosowanie             |
| ------------------ | ---------------------------------------- | ------------------------ |
| AI Product Owner   | Zarządzanie cyklem życia AI, compliance  | Wdrażanie modeli AI      |
| AI Risk Officer    | Zarządzanie ryzykiem, etyka, audyt       | Monitorowanie incydentów |
| AI Orchestrator    | Koordynacja agentów, integracja systemów | Automatyzacja procesów   |
| Prompt Engineer    | Optymalizacja interakcji z modelami      | Wszystkie działy         |
| Data Curator       | Zarządzanie danymi treningowymi          | AI/ML teams              |
